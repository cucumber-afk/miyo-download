import { DOWNLOADS_CATEGORY_OPTIONS, HOME_FEATURED_LIMIT_DEFAULT, HOME_HOW_STEP_COUNT } from './pageConfigConstants.js';

export const DEFAULT_PAGE_CONFIG_BACKEND = {
  home: {
    hero: {
      enabled: true,
      sortOrder: 0,
  ...
  support: {
    ...
    faq: {
      ...
      design: { layoutStyle: 'grid', spacing: 'normal', backgroundColor: '' },
    ...
    contactCta: {
      ...
      design: { backgroundColor: '', textAlignment: 'left', spacing: 'normal', buttonStyle: 'dark' },
      layout: { enabled: true, sortOrder: 3, visibilityBreakpoints: { desktop: true, tablet: true, mobile: true } },
      media: {},
      seo: {},
    },
  },
  characters: {
    header: {
      ...
      sortOrder: 0,
      content: {
        sectionKicker: 'Characters',
        title: 'Explore the',
        titleHighlight: 'MiYo world.',
        description: 'New collections will appear here as the MiYo character library grows.',
      },
      design: { contentAlignment: 'left', spacing: 'normal', backgroundColor: '' },
      layout: { enabled: true, sortOrder: 0, visibilityBreakpoints: { desktop: true, tablet: true, mobile: true } },
      media: {},
    ...
    collectionGrid: {
      ...
      content: {
        collections: [
          { slotId: 'everyday', title: 'Everyday Expressions', shortTitle: 'Everyday', description: 'For everyday moods and reactions.', tone: 'yellow', enabled: true, sortOrder: 0 },
          { slotId: 'mood', title: 'Mood Collection', shortTitle: 'Mood', description: 'Happy, sleepy, excited, silly and more.', tone: 'coral', enabled: true, sortOrder: 1 },
          { slotId: 'seasonal', title: 'Seasonal Packs', shortTitle: 'Seasonal', description: 'Fresh content for holidays and special moments.', tone: 'blue', enabled: true, sortOrder: 2 },
          { slotId: 'special', title: 'Special Editions', shortTitle: 'Special', description: 'Unique collections and limited releases.', tone: 'pink', enabled: true, sortOrder: 3 },
        ],
      },
